...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" align="center"  style="background-color: #1B396A; color: white;">{{ __('Actualizar Contraseña D') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('update.docentes',$user->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                    ...
                    <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <td><a class= "btn btn-primary" href ="{{route('mainDocente')}}" class="center" 
